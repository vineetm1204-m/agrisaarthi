...
const MOCK_SCHEMES = [
  ...
  {
    name: "MP Irrigation Tax Penalty Waiver",
    ministry: "Department of Revenue, Madhya Pradesh",
    is_state_scheme: true,
    benefit_inr: 5000,
    eligibility_criteria: ["Farmers with outstanding irrigation water tax", "Payment of principal amount before deadline"],
    documents_needed: ["Water tax bill", "Land records", "ID Proof"],
    application_url: "http://www.mpwrd.gov.in/",
    deadline: "March 31, 2026",
    already_enrolled: false,
  },
  {
    name: "Fal Podharopan Yojana (Fruit Plantation)",
    ministry: "Horticulture Department, Madhya Pradesh",
    is_state_scheme: true,
    benefit_inr: 40000,
    eligibility_criteria: ["Land holding 0.25 to 4 hectares", "Willingness to establish fruit orchard"],
    documents_needed: ["Khasra/B-1 records", "Aadhaar Card", "Bank Passbook"],
    application_url: "https://mpfsts.mp.gov.in/",
    deadline: "Varies by Season",
    already_enrolled: false,
  },
  {
    name: "Male Goat Distribution Scheme",
    ministry: "Animal Husbandry Department, Madhya Pradesh",
    is_state_scheme: true,
    benefit_inr: 15000,
    eligibility_criteria: ["Rural farmers", "Livestock owners looking to improve breeds"],
    documents_needed: ["Aadhaar Card", "Caste Certificate (if applicable)", "Land/Livestock proof"],
    application_url: "https://mpdah.gov.in/",
    deadline: "Open All Year",
    already_enrolled: false,
  },
];
